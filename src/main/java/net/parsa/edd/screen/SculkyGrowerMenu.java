...
public class SculkyGrowerMenu extends AbstractContainerMenu {
    ...
    public SculkyGrowerMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 27, 54));
            this.addSlot(new ModResultSlot(handler, 2, 135, 37));
        });
    }
